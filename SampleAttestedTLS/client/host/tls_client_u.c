...
static sgx_status_t SGX_CDECL tls_client_u_sgxssl_ftime(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_sgxssl_write(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_sgxssl_read(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_sgxssl_close(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_sgxssl_open(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_sgx_oc_cpuidex(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_sgx_thread_wait_untrusted_event_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_sgx_thread_set_untrusted_event_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_sgx_thread_setwait_untrusted_events_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_sgx_thread_set_multiple_untrusted_events_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_pthread_wait_timeout_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_pthread_create_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_pthread_wakeup_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_opendir(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_readdir(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_rewinddir(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_closedir(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_telldir(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_seekdir(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getdents64(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fcntl(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_open(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_openat(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_stat(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_lstat(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fstat(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_mkdir(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fchmod(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_socket(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_bind(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_listen(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_accept(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_connect(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_send(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_sendto(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_sendmsg(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_recv(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_recvfrom(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_recvmsg(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getsockopt(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_setsockopt(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_poll(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_select(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getsockname(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getpeername(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_socketpair(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_shutdown(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_realpath(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fprintf(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fgets(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fopen(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fdopen(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fclose(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fread(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fwrite(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_rewind(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fflush(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_clearerr(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_feof(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_ferror(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fileno(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getline(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getdelim(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_malloc(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_free(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_uname(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_epoll_create1(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_epoll_wait(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_epoll_ctl(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_mount(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_umount2(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_gethostname(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getdomainname(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getcwd(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_chdir(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_nanosleep(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_clock_nanosleep(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getpid(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getppid(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getpgrp(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getuid(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_geteuid(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getgid(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getegid(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getpgid(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getgroups(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_read(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_write(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_close(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_flock(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fsync(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fdatasync(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fchown(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_dup(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_dup2(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_rmdir(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_link(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_unlink(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_truncate(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_ftruncate(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_lseek(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_pread(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_pwrite(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_readv(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_writev(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_access(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_readlink(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_sysconf(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_rename(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_remove(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getenv(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getgrgid_r(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getpwuid(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getpwuid_r(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_fpathconf(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_pathconf(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_time(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_utimes(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_localtime(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_gettimeofday(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_clock_gettime(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getaddrinfo(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_freeaddrinfo(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_getnameinfo(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_gai_strerror(void* pms)
{
...
static sgx_status_t SGX_CDECL tls_client_u_sched_yield(void* pms)
{
...
static const struct {
	size_t nr_ocall;
	void * table[126];
} ocall_table_tls_client = {
	126,
	{
		(void*)tls_client_u_sgxssl_ftime,
		(void*)tls_client_u_sgxssl_write,
		(void*)tls_client_u_sgxssl_read,
		(void*)tls_client_u_sgxssl_close,
		(void*)tls_client_u_sgxssl_open,
		(void*)tls_client_sgx_oc_cpuidex,
		(void*)tls_client_sgx_thread_wait_untrusted_event_ocall,
		(void*)tls_client_sgx_thread_set_untrusted_event_ocall,
		(void*)tls_client_sgx_thread_setwait_untrusted_events_ocall,
		(void*)tls_client_sgx_thread_set_multiple_untrusted_events_ocall,
		(void*)tls_client_pthread_wait_timeout_ocall,
		(void*)tls_client_pthread_create_ocall,
		(void*)tls_client_pthread_wakeup_ocall,
		(void*)tls_client_u_opendir,
		(void*)tls_client_u_readdir,
		(void*)tls_client_u_rewinddir,
		(void*)tls_client_u_closedir,
		(void*)tls_client_u_telldir,
		(void*)tls_client_u_seekdir,
		(void*)tls_client_u_getdents64,
		(void*)tls_client_u_fcntl,
		(void*)tls_client_u_open,
		(void*)tls_client_u_openat,
		(void*)tls_client_u_stat,
		(void*)tls_client_u_lstat,
		(void*)tls_client_u_fstat,
		(void*)tls_client_u_mkdir,
		(void*)tls_client_u_fchmod,
		(void*)tls_client_u_socket,
		(void*)tls_client_u_bind,
		(void*)tls_client_u_listen,
		(void*)tls_client_u_accept,
		(void*)tls_client_u_connect,
		(void*)tls_client_u_send,
		(void*)tls_client_u_sendto,
		(void*)tls_client_u_sendmsg,
		(void*)tls_client_u_recv,
		(void*)tls_client_u_recvfrom,
		(void*)tls_client_u_recvmsg,
		(void*)tls_client_u_getsockopt,
		(void*)tls_client_u_setsockopt,
		(void*)tls_client_u_poll,
		(void*)tls_client_u_select,
		(void*)tls_client_u_getsockname,
		(void*)tls_client_u_getpeername,
		(void*)tls_client_u_socketpair,
		(void*)tls_client_u_shutdown,
		(void*)tls_client_u_realpath,
		(void*)tls_client_u_fprintf,
		(void*)tls_client_u_fgets,
		(void*)tls_client_u_fopen,
		(void*)tls_client_u_fdopen,
		(void*)tls_client_u_fclose,
		(void*)tls_client_u_fread,
		(void*)tls_client_u_fwrite,
		(void*)tls_client_u_rewind,
		(void*)tls_client_u_fflush,
		(void*)tls_client_u_clearerr,
		(void*)tls_client_u_feof,
		(void*)tls_client_u_ferror,
		(void*)tls_client_u_fileno,
		(void*)tls_client_u_getline,
		(void*)tls_client_u_getdelim,
		(void*)tls_client_u_malloc,
		(void*)tls_client_u_free,
		(void*)tls_client_u_uname,
		(void*)tls_client_u_epoll_create1,
		(void*)tls_client_u_epoll_wait,
		(void*)tls_client_u_epoll_ctl,
		(void*)tls_client_u_mount,
		(void*)tls_client_u_umount2,
		(void*)tls_client_u_gethostname,
		(void*)tls_client_u_getdomainname,
		(void*)tls_client_u_getcwd,
		(void*)tls_client_u_chdir,
		(void*)tls_client_u_nanosleep,
		(void*)tls_client_u_clock_nanosleep,
		(void*)tls_client_u_getpid,
		(void*)tls_client_u_getppid,
		(void*)tls_client_u_getpgrp,
		(void*)tls_client_u_getuid,
		(void*)tls_client_u_geteuid,
		(void*)tls_client_u_getgid,
		(void*)tls_client_u_getegid,
		(void*)tls_client_u_getpgid,
		(void*)tls_client_u_getgroups,
		(void*)tls_client_u_read,
		(void*)tls_client_u_write,
		(void*)tls_client_u_close,
		(void*)tls_client_u_flock,
		(void*)tls_client_u_fsync,
		(void*)tls_client_u_fdatasync,
		(void*)tls_client_u_fchown,
		(void*)tls_client_u_dup,
		(void*)tls_client_u_dup2,
		(void*)tls_client_u_rmdir,
		(void*)tls_client_u_link,
		(void*)tls_client_u_unlink,
		(void*)tls_client_u_truncate,
		(void*)tls_client_u_ftruncate,
		(void*)tls_client_u_lseek,
		(void*)tls_client_u_pread,
		(void*)tls_client_u_pwrite,
		(void*)tls_client_u_readv,
		(void*)tls_client_u_writev,
		(void*)tls_client_u_access,
		(void*)tls_client_u_readlink,
		(void*)tls_client_u_sysconf,
		(void*)tls_client_u_rename,
		(void*)tls_client_u_remove,
		(void*)tls_client_u_getenv,
		(void*)tls_client_u_getgrgid_r,
		(void*)tls_client_u_getpwuid,
		(void*)tls_client_u_getpwuid_r,
		(void*)tls_client_u_fpathconf,
		(void*)tls_client_u_pathconf,
		(void*)tls_client_u_time,
		(void*)tls_client_u_utimes,
		(void*)tls_client_u_localtime,
		(void*)tls_client_u_gettimeofday,
		(void*)tls_client_u_clock_gettime,
		(void*)tls_client_u_getaddrinfo,
		(void*)tls_client_u_freeaddrinfo,
		(void*)tls_client_u_getnameinfo,
		(void*)tls_client_u_gai_strerror,
		(void*)tls_client_u_sched_yield,
	}
};
sgx_status_t launch_tls_client(sgx_enclave_id_t eid, int* retval, char* server_name, char* server_port, const char* input_file, const char* output_file)
{
	sgx_status_t status;
	ms_launch_tls_client_t ms;
	ms.ms_server_name = server_name;
	ms.ms_server_name_len = server_name ? strlen(server_name) + 1 : 0;
	ms.ms_server_port = server_port;
	ms.ms_server_port_len = server_port ? strlen(server_port) + 1 : 0;
	ms.ms_input_file = input_file;
	ms.ms_input_file_len = input_file ? strlen(input_file) + 1 : 0;
	ms.ms_output_file = output_file;
	ms.ms_output_file_len = output_file ? strlen(output_file) + 1 : 0;
	status = sgx_ecall(eid, 0, &ocall_table_tls_client, &ms);
